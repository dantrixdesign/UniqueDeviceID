...
public class UniqueDeviceID extends CordovaPlugin {
  ...
  protected static final String permission =
  ...
  private boolean hasPermission(String permission) throws Exception {
    ...
    try {
      method =
        cordova.getClass().getMethod("hasPermission", permission.getClass());
      ...
      Log.w(
        ...
        " does not support API 23 runtime permissions so defaulting to GRANTED for " +
        permission
      );
    }
  ...
  private void requestPermission(
    ...
    throws Exception {
    try {
      java.lang.reflect.Method method = cordova
        .getClass()
        .getMethod(
          "requestPermission",
      ...
      throw new Exception(
        "requestPermission() method not found in CordovaInterface implementation of Cordova v" +
        CordovaWebView.CORDOVA_VERSION
      );
    }
  }
